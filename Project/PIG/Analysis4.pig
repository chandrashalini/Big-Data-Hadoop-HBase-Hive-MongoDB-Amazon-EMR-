...
STORE OUTBOUND_IATA_COUNT INTO '/pigData/Project/Analysis4/OUTBOUND.txt' USING PigStorage(',');
STORE INBOUND_IATA_COUNT INTO '/pigData/Project/Analysis4/INBOUND.txt' USING PigStorage(',');
*/
...
STORE topMonthlyInbound INTO '/pigData/Project/Analysis4/INBOUND-TOP' USING PigStorage(',');
...
STORE topMonthlyOutbound INTO '/pigData/Project/Analysis4/OUTBOUND-TOP' USING PigStorage(',');
...
STORE topMonthlyTraffic INTO '/pigData/Project/Analysis4/MONTHLY-TRAFFIC-TOP/' USING PigStorage(',');
